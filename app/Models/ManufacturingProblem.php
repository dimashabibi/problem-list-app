...
class ManufacturingProblem extends Model
{
    use HasFactory;

    protected $table = 'manufacturing_problems';
    ...
    {
        return $this->hasMany(ManufacturingProblemAttachment::class, 'problem_id', 'id_problem');
    }
}
