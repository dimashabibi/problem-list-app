...
<head>
    <!-- Title Meta -->
    <meta charset="utf-8" />
    <title>Sign In | Velok - Responsive Admin Dashboard Template</title>
                                ...
                                <div class="p-3">
                                    <form action="index.html" class="authentication-form">
                                        ...
                                        <div class="mb-4">
                                            <a href="auth-password.html"
                                                class="float-end fw-semibold text-reset ms-1">Reset password</a>
                                        ...
                                        <div class="text-center d-grid">
                                            <button
                                                ...
                                                type="submit"><i data-lucide="log-in" class="fs-18"></i> Sign
                                                In</button>
                                        </div>
                                    </form>
                                    ...
                                    <div class="d-flex align-items-center justify-content-center gap-3 text-center">
                                        <a href="javascript:void(0);"
                                            class="btn btn-outline-danger shadow px-2 d-flex align-items-center justify-content-center gap-1 fw-medium">
                                            <iconify-icon icon="flat-color-icons:google" class="fs-20"></iconify-icon>
                                            Google
                                        </a>
                                        <a href="javascript:void(0);"
                                            class="btn btn-outline-primary shadow px-2 d-flex align-items-center justify-content-center gap-1 fw-medium">
                                            <iconify-icon icon="logos:facebook" class="fs-20"></iconify-icon>
                                            Facebook
                                        </a>
                                        <a href="javascript:void(0);"
                                            class="btn btn-outline-dark shadow px-2 d-flex align-items-center justify-content-center gap-1 fw-medium">
